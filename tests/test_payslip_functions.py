...
class test_payslip_functions(unittest.TestCase):
    ...
    def test_normal_case(self):
        self.assertEqual(number_cruncher(
            ['a', 'b', '60050', '9', '1/3/2016']),
            ('a b', 'March', 5004, 0, 5004, 450)
            )
    ...
    def test_invalid_super_rate(self):
        self.assertEqual(number_cruncher(
            ['a', 'b', '-60050.5', '-1', '1/3/2016']),
            ('a b', 'March', 5004, 0, 5004, 0)
            )

    def test_invalid_super_rate(self):
        self.assertEqual(number_cruncher(
            ['a', 'b', '-60050.5', '51', '1/3/2016']),
            ('a b', 'March', 5004, 0, 5004, 0)
            )
